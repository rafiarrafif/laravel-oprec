<!DOCTYPE html>
<html lang="en" style="background: #4764F9 !important">
...
<body class="h-screen">
    <main class="h-screen flex flex-col">
        <div id="top" class="pt-8 mx-4 flex-grow">
            ...
            <h3 class="mt-4 text-4xl text-white font-bold uppercase font-montserrat">Anda dinyatakan telah lolos seleksi
                osis
            </h3>
            <p class="text-xs mt-3 text-white font-light uppercase font-montserrat">Selamat dan sukses atas amanah yang
                akan
                kamu emban! Semoga kamu diberi kekuatan dan kebijaksanaan untuk
                menjalankannya dengan baik.</p>
        </div>
